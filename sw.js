const CACHE_NAME = 'tip-v3-12-unified-tip-library-1';
const APP_SHELL = [
  ...
  './js/coach/topics.js','./js/coach/signals.js','./js/coach/memory.js','./js/coach/recommend.js','./js/coach/catalog.js','./js/coach/library.js','./js/coach/legacy-library-data.js','./js/coach/compose-session.js',
